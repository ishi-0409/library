...
function App() {
  ...
  const handleSearch = async (input) => {
    ...
    setError(null)
    try {
      const apiUrl = import.meta.env.VITE_API_URL || 'https://9lkbaom8zg.execute-api.ap-northeast-1.amazonaws.com'
      const res = await fetch(`${apiUrl}/match?input=${encodeURIComponent(input)}`)
